...
*Instructions: Open all 7 links in seperate browser tabs and walk through the following steps.*
...
5. [Website](http://colorado.rstudio.com:3939/connect/#/apps/888/access). Embed the Shiny app into a website using an iframe. This app is ready to be accessed to hundreds (or thousands) of concurrent users.
...
7. [API](http://colorado.rstudio.com:3939/connect/#/apps/890/access). Create an API to deliver the data, table, or plot to a system call. 
